...
const alternatives = [
  ...
  },
  {
    ...
    primaryToolSlug: "gorgias",
    alternativeToolSlugs: ["tidio"],
    intro: "Gorgias is a strong commerce helpdesk, but not every store needs a full support operations platform. Teams often compare alternatives when they want simpler live chat, lighter chatbot automation, or a lower-friction starting point.",
    whyLookForAlternatives: [
      "Support volume is not high enough to justify a deeper helpdesk",
      "The team wants live chat and chatbot automation before ticket operations",
      "Pricing needs to match a smaller support workload",
      "The store wants to validate whether chat improves conversion or support quality first",
    ],
    selectionCriteria: [
      "Live chat quality",
      "AI chatbot and automation setup",
      "Ease of use for small teams",
      "Escalation workflow from bot to human",
      "Pricing fit for conversation volume",
      "Commerce platform integration quality",
    ],
    verdict: "Tidio is the first Gorgias alternative to review when a store wants a lighter live chat and chatbot setup before moving into full support operations.",
    seoTitle: "Best Gorgias Alternatives for E-commerce Support",
    seoDescription: "Compare Gorgias alternatives for online stores, including lighter live chat, AI chatbot, support automation, pricing fit, and helpdesk tradeoffs.",
  },
  {
    title: "Best Zapier Alternatives",
    slug: "zapier-alternatives",
    primaryToolSlug: "zapier",
    alternativeToolSlugs: ["n8n"],
    intro: "Zapier is the default automation choice for many teams, but technical operators may compare alternatives when workflows need more control, custom logic, or self-hosting options.",
    whyLookForAlternatives: [
      "Task volume makes no-code automation pricing harder to justify",
      "The workflow needs custom logic or API-heavy data handling",
      "The team wants self-hosting or more control over execution",
      "Business-critical automations need stronger ownership and monitoring",
    ],
    selectionCriteria: [
      "App and API integration coverage",
      "Workflow control and branching logic",
      "Self-hosting or cloud deployment options",
      "Maintenance effort for the team",
      "Error handling and monitoring",
      "Pricing fit at expected automation volume",
    ],
    verdict: "n8n is the first Zapier alternative to review when technical control, self-hosting, and custom workflow logic matter more than the simplest no-code setup.",
    seoTitle: "Best Zapier Alternatives for E-commerce Automation",
    seoDescription: "Compare Zapier alternatives for e-commerce automation, including n8n for self-hosting, custom workflows, API automation, pricing, and maintenance tradeoffs.",
  },
  {
    title: "Best Semrush Alternatives",
    slug: "semrush-alternatives",
    primaryToolSlug: "semrush",
    alternativeToolSlugs: ["ahrefs", "surfer-seo"],
    intro: "Semrush is broad, but some e-commerce teams compare alternatives when they need deeper backlink research, a different keyword workflow, or a more focused content optimization process.",
    whyLookForAlternatives: [
      "The team mostly needs SEO research rather than a broad visibility suite",
      "Backlink and competitor page analysis are the highest-priority workflows",
      "Content briefs and on-page optimization matter more than all-in-one reporting",
      "Pricing should match the SEO jobs the team will actually do every week",
    ],
    selectionCriteria: [
      "Keyword and competitor research",
      "Backlink analysis depth",
      "Content brief and optimization workflow",
      "Technical SEO and audit needs",
      "Team workflow fit",
      "Pricing fit for planned SEO activity",
    ],
    verdict: "Ahrefs is the first Semrush alternative to review for backlink and SEO research depth. Surfer SEO is the focused alternative when content briefs and on-page optimization are the main jobs.",
    seoTitle: "Best Semrush Alternatives for E-commerce SEO",
    seoDescription: "Compare Semrush alternatives for e-commerce SEO, including Ahrefs and Surfer SEO for keyword research, backlinks, content briefs, pricing, and workflow fit.",
  },
  {
    title: "Best Canva Alternatives",
    slug: "canva-alternatives",
    primaryToolSlug: "canva",
    alternativeToolSlugs: ["adcreative-ai", "replo", "shopify-magic"],
    intro: "Canva is a flexible design workspace, but commerce teams may compare alternatives when they need more ad-variant generation, Shopify landing-page production, or native store content assistance.",
    whyLookForAlternatives: [
      "The team needs more paid ad creative variants for testing",
      "Campaign pages and landing pages matter more than general design assets",
      "The store wants native Shopify AI help rather than a separate design workspace",
      "Template-based visuals are not enough for performance creative or campaign pages",
    ],
    selectionCriteria: [
      "Creative production speed",
      "Ad testing and variant generation",
      "Shopify landing-page fit",
      "Brand consistency and review workflow",
      "Ease of use for non-designers",
      "Pricing fit for creative volume",
    ],
    verdict: "AdCreative.ai is the first Canva alternative to review for paid ad variant generation. Replo is the stronger alternative when Shopify campaign pages are the real bottleneck.",
    seoTitle: "Best Canva Alternatives for E-commerce Marketing",
    seoDescription: "Compare Canva alternatives for e-commerce brands, including AdCreative.ai, Replo, and Shopify Magic for ad creative, landing pages, and store content workflows.",
  },
];
