...
export interface ApiAlternativeAlternative extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: '\u56F4\u7ED5\u67D0\u4E2A\u5DE5\u5177\u7684 alternatives \u641C\u7D22\u610F\u56FE\u9875\u9762\u3002';
    displayName: '\u66FF\u4EE3\u54C1\u9875\u9762';
  ...
  attributes: {
    alternativeTools: Schema.Attribute.Relation<'manyToMany', 'api::tool.tool'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    primaryTool: Schema.Attribute.Relation<'manyToOne', 'api::tool.tool'>;
    publishedAt: Schema.Attribute.DateTime;
    ...
    whyLookForAlternatives: Schema.Attribute.JSON;
  };
}
...
export interface ApiComparisonComparison extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    featureNotes: Schema.Attribute.JSON;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    title: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    toolA: Schema.Attribute.Relation<'manyToOne', 'api::tool.tool'>;
    toolB: Schema.Attribute.Relation<'manyToOne', 'api::tool.tool'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    verdict: Schema.Attribute.Text;
...
export interface ApiImportLogImportLog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    runStatus: Schema.Attribute.Enumeration<
      ['started', 'success', 'partial_success', 'failed']
    > &
      Schema.Attribute.Required &
...
export interface ApiSourceSource extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    fetchFrequency: Schema.Attribute.Enumeration<
      ['manual', 'daily', 'weekly', 'monthly']
    > &
      Schema.Attribute.DefaultTo<'manual'>;
    importLogs: Schema.Attribute.Relation<
      'oneToMany',
      'api::import-log.import-log'
    >;
    ...
    permissionNotes: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiToolTool extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    affiliateDisclosure: Schema.Attribute.Text;
    affiliateUrl: Schema.Attribute.String;
    automationDepthScore: Schema.Attribute.Integer &
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    decisionSummary: Schema.Attribute.Text;
    easeOfUseScore: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          max: 5;
          min: 1;
    ...
    freePlanAvailable: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    integrationScore: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          max: 5;
          min: 1;
    ...
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    notRecommendedFor: Schema.Attribute.JSON;
    pricingModel: Schema.Attribute.Enumeration<
      ['free', 'freemium', 'paid', 'custom', 'unknown']
    > &
      Schema.Attribute.DefaultTo<'unknown'>;
    pricingValueScore: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          max: 5;
          min: 1;
    ...
    publishedAt: Schema.Attribute.DateTime;
    recommendedFor: Schema.Attribute.JSON;
    seoDescription: Schema.Attribute.Text;
    seoTitle: Schema.Attribute.String;
    seoUsefulnessScore: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          max: 5;
          min: 1;
    ...
    slug: Schema.Attribute.UID<'name'> & Schema.Attribute.Required;
    sources: Schema.Attribute.Relation<'manyToMany', 'api::source.source'>;
    sourceUrls: Schema.Attribute.JSON;
    startingPrice: Schema.Attribute.Decimal;
    supportQualityScore: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          max: 5;
          min: 1;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::best-list.best-list': ApiBestListBestList;
